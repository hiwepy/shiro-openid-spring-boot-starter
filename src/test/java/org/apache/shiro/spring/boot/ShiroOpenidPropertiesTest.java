...
/**
 * Unit tests for {{ @link ShiroOpenidProperties }}.
 *
 ...
 * @since 1.0.0
 */
@DisplayName("ShiroOpenidProperties Tests")
class ShiroOpenidPropertiesTest {
    ...
    void testEnabledField() {
        ...
        try {
            java.lang.reflect.Field f = ShiroOpenidProperties.class.getDeclaredField("enabled");
