...
/**
 * MITREid Connect Openid 认证 (authentication)过滤器
 * @author ： <a href="https://github.com/vindell">vindell</a>
 */
public class MITREidConnectAuthenticatingFilter extends AbstractTrustableAuthenticatingFilter {

	private static final Logger LOG = LoggerFactory.getLogger(MITREidConnectAuthenticatingFilter.class);
	private SSOHandlerInterceptor handlerInterceptor;
	
	public MITREidConnectAuthenticatingFilter() {
		super();
	}
